...
const quizData = [
  {
    ...
    correct: 1,
    explanation:
      "Alkitab terdiri dari 66 kitab, 39 kitab Perjanjian Lama dan 27 kitab Perjanjian Baru.",
  },
  {
    id: 2,
    question: "Siapa yang menulis Injil pertama dalam Perjanjian Baru?",
    options: ["Markus", "Matius", "Lukas", "Yohanes"],
    correct: 1,
    explanation:
      "Injil Matius adalah kitab pertama dalam Perjanjian Baru dan ditulis oleh rasul Matius.",
  },
  {
    id: 3,
    ...
    correct: 2,
    explanation:
      "Yesus dilahirkan di Betlehem, kota Daud, sesuai dengan nubuatan Mikha 5:2.",
  },
  {
    id: 4,
    question: "Berapa jumlah murid Yesus yang dipilih?",
    options: ["10", "12", "14", "16"],
    correct: 1,
    explanation:
      "Yesus memilih 12 murid yang disebut rasul untuk menyebarkan Injil ke seluruh dunia.",
  },
  {
    id: 5,
    ...
    correct: 2,
    explanation:
      "Mukjizat pertama Yesus adalah mengubah air menjadi anggur di pesta pernikahan di Kana.",
  },
  {
    id: 6,
    question: "Siapa yang memimpin bangsa Israel keluar dari Mesir?",
    options: ["Abraham", "Musa", "Daud", "Yosua"],
    correct: 1,
    explanation:
      "Musa dipanggil Allah untuk memimpin bangsa Israel keluar dari perbudakan di Mesir.",
  },
  {
    id: 7,
    question: "Apa ayat emas dalam Alkitab yang paling terkenal?",
    options: ["Mazmur 23:1", "Yohanes 3:16", "Roma 8:28", "Filipi 4:13"],
    correct: 1,
    explanation:
      "Yohanes 3:16 sering disebut ayat emas karena merangkum inti pesan Injil tentang kasih Allah.",
  },
  {
    id: 8,
    question: "Berapa hari Yesus berpuasa di padang gurun?",
    options: ["30 hari", "40 hari", "50 hari", "60 hari"],
    correct: 1,
    explanation:
      "Yesus berpuasa selama 40 hari 40 malam di padang gurun sebelum memulai pelayanan-Nya.",
  },
  {
    id: 9,
    question: "Siapa raja Israel yang terkenal karena kebijaksanaannya?",
    options: ["Daud", "Salomo", "Saul", "Hizkia"],
    correct: 1,
    explanation:
      "Raja Salomo terkenal karena kebijaksanaannya dan membangun Bait Suci yang pertama.",
  },
  {
    id: 10,
    question: "Apa nama buah yang dilarang dimakan Adam dan Hawa?",
    options: [
      "Apel",
      "Anggur",
    ...
    correct: 2,
    explanation:
      "Alkitab menyebutnya sebagai buah dari pohon pengetahuan baik dan jahat, bukan secara spesifik apel.",
  },
];
