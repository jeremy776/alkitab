  ...
  return (
    <>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <aside>
          <h1 className="text-3xl font-bold">Alkitab.com</h1>
          <p>Terhubung dengan Firman, Menemukan Makna Sejati Hidup</p>
        </aside>
        <nav>
          <h6 className="footer-title">Alkitab</h6>
          <a className="link link-hover">Ayat harian</a>
        ...
        <nav>
          <h6 className="footer-title">Hukum</h6>
          <a className="link link-hover">Syarat Penggunaan</a>
          <a className="link link-hover">Kebijakan pribadi</a>
        </nav>
      </footer>
      <footer className="footer pb-20 px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>LazyyPeople. <br />technology organization since 2022</p>
        </aside>
