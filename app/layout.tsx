...
export const metadata: Metadata = {
  ...
  icons: "/logo.png",
  description: "SelaVibes adalah aplikasi rohani yang chill dan kekinian. Temukan lagu pujian, ayat harian, dan trivia seru buat hidup yang makin teduh dan bermakna.",
  keywords: [
    "SelaVibes",
  ...
  openGraph: {
    title: "SelaVibes | Teduhin Hidupmu, Dekat Sama Tuhan",
    description: "Explore SelaVibes — app rohani untuk anak muda! Lagu, ayat, dan konten kekinian yang bisa bikin hati tenang dan jiwa naik level.",
  ...
  twitter: {
    ...
    title: "SelaVibes | Teduhin Hidupmu, Dekat Sama Tuhan",
    description: "Aplikasi rohani modern buat kamu yang pengen deket sama Tuhan tanpa ribet.",
